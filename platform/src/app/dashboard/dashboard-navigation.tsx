...
const items: Array<{ id: ActiveItem; label: string; href: string; icon: React.ReactNode }> = [
  { id: 'resumen', label: 'Resumen', href: '/dashboard?section=resumen', icon: <path d="M3 11.5 12 4l9 7.5M5.5 10v10h13V10M9 20v-6h6v6" /> },
  { id: 'inteligencia', label: 'Inteligencia', href: '/dashboard?section=inteligencia', icon: <path d="m12 3 1.7 4.3L18 9l-4.3 1.7L12 15l-1.7-4.3L6 9l4.3-1.7L12 3ZM5 15l.9 2.1L8 18l-2.1.9L5 21l-.9-2.1L2 18l2.1-.9L5 15Zm14-1 1.1 2.9L23 18l-2.9 1.1L19 22l-1.1-2.9L15 18l2.9-1.1L19 14Z" /> },
