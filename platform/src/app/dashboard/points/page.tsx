  ...
  return <main className="dashboardApp nivalDashboard">
    ...
    <div className={`dashboardContent ${!available ? "nivalPointsDark" : ""}`}>
      ...
      {!available ? <>
        ...
        {canManage && view === 'analytics' && freePlan && <section className="freemiumLocked"><span>RESULTADOS PRO</span><h2>Nival ya está registrando la actividad. Pro te ayuda a entender si realmente están volviendo.</h2><p>Desbloquea recurrencia, clientes activos, premios usados y recomendaciones para mejorar el programa.</p><form action={startNivalPointsSubscription} className="subscriptionConsentForm"><label className="checkLabel"><input type="checkbox" name="subscriptionConsent" required /><span>Nival Puntos Pro cuesta $199 MXN al mes y se cobra de forma recurrente hasta que canceles. Confirmo que entiendo y autorizo el cobro mensual. <a href="/terms" target="_blank" rel="noreferrer">Ver términos</a>.</span></label><button type="submit">Desbloquear resultados · $199/mes →</button></form></section>}
