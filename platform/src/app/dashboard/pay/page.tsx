    ...
    <div className="dashboardContent dashboardPayContent">
      ...
      <section className="dashboardHero">
        <div>
          ...
          <p>Recibe transferencias con un enlace y QR propios. Precio temporal para validar pagos reales: $1 MXN.</p>
          <a className="loginLink" href="/checkout">Activar Nival Pay · $1 MXN (prueba)</a>
        </div>
      </section>
