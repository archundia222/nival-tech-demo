...
{sections.map((section, index) => <div className="customPaySection" key={section.id} style={{position:"relative",paddingTop:"3.2rem"}}>
        ...
        <div className="inlineApartados">
          <p className="apartadoIntro">Tu Nival Pay incluye <strong>3 apartados</strong>. Después puedes agregar los que necesites por ${extraSectionPriceMx} MXN cada uno.</p>
