  ...
  return <main className="payWorkspace nivalProductsPage">
    ...
    <div className="payProductGrid nivalProductsGrid">
      ...
      <article className="payProduct">
        ...
        <ul><li>Registro con QR</li><li>Tarjeta digital y recompensas reales</li><li>Pro: más clientes, resultados y configuración</li></ul>
      ...
      <article className="payProduct intelligenceProductCard">
        ...
        <ul><li>Gratis: señal y recomendación principal</li><li>Pro: personas, mensajes y campañas</li><li>Pro: resultados y aprendizaje</li></ul>
