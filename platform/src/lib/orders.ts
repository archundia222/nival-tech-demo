...
export const NIVAL_PAY_PRICE_CENTS = 100;
...
export const NIVAL_PAY_ADDITIONAL_PRICE_CENTS = 100;
export const NIVAL_PAY_ADDITIONAL_PRODUCT = 'nival_pay_additional';

export const NIVAL_PAY_EXTRA_SECTION_PRICE_CENTS = 100;
...
export const NIVAL_POINTS_PRICE_CENTS = 100;
export const NIVAL_INTELLIGENCE_PRICE_CENTS = 100;
export const NIVAL_POINTS_INTELLIGENCE_PRICE_CENTS = 100;
